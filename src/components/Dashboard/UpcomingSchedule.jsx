    ...
    <div className="mt-[30px] md:mt-0 w-full">
      <div className="relative flex flex-col space-y-[8px] border-[1px] border-[#E0E0E0] rounded-[10px] p-[20px]">
        ...
        <div className="flex flex-col space-y-[8px]">
          <div className="text-[#686868] text-[12px]">Priority</div>
          ...
          <div className="text-[#686868] text-[12px]">Other</div>
          <div className="border-[0.5px] bg-[#FAFAFA] mt-[8px] rounded-[6px] px-2">
            <div className="text-[14px] py-[5px] font-light">
            Interview with candidates
            </div>
            <div className="py-2 flex justify-between">
              <div className="text-[#686868] text-[10px] font-normal">
                Today - 10:30 AM
              </div>
              <div className="flex space-x-[10px]">
                <img src={menuDots} alt="" />
          ...
          <div className="border-[0.5px] bg-[#FAFAFA] mt-[8px] rounded-[6px] px-2 md:hidden lg:block">
            <div className="text-[14px] py-[5px] font-light">
        ...
        <div className="text-[#FF5151] text-center pt-[10px]">
